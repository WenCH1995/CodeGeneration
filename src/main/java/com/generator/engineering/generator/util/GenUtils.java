package com.generator.engineering.generator.util;

import cn.hutool.core.date.DateUtil;
import cn.hutool.core.io.IoUtil;
import cn.hutool.core.util.CharsetUtil;
import cn.hutool.core.util.StrUtil;
import com.generator.engineering.dao.generator.entity.ColumnEntity;
import com.generator.engineering.dao.generator.entity.GenConfig;
import com.generator.engineering.dao.generator.entity.TableEntity;
import com.generator.engineering.generator.exception.CheckedException;
...
public class GenUtils {
    ...
    private static String getFileName(String template, String className, String packageName, String moduleName) {
        String packagePath = "tunny" + File.separator + "src" + File.separator + "main" + File.separator + "java" + File.separator;
        ...
        if (template.contains(MAPPER_XML_VM)) {
            return "tunny" + File.separator + "src" + File.separator + "main" + File.separator + "resources" + File.separator + "mapper" + File.separator + className + "Mapper.xml";
        }
        ...
        if (template.contains(INDEX_VUE_VM)) {
            return "tunny-ui" + File.separator + "src" + File.separator + "views" +
                    File.separator + moduleName + File.separator + className.toLowerCase() + File.separator + "index.vue";
        }

        if (template.contains(API_JS_VM)) {
            return "tunny-ui" + File.separator + "src" + File.separator + "api" + File.separator + className.toLowerCase() + ".js";
        }

        if (template.contains(CRUD_JS_VM)) {
            return "tunny-ui" + File.separator + "src" + File.separator + "const" +
